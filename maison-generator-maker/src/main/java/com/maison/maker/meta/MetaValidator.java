...
import com.maison.maker.meta.enums.FileGenerateTypeEnum;
import com.maison.maker.meta.enums.FileTypeEnum;
import com.maison.maker.meta.enums.ModelTypeEnum;
...
//            String type = fileInfo.getType();
    ...
    public static void validAndFillMetaRoot(Meta meta) {
        ...
        String author = StrUtil.emptyToDefault(meta.getAuthor(), "maison");
        String basePackage = StrUtil.blankToDefault(meta.getBasePackage(), "com.maison");
