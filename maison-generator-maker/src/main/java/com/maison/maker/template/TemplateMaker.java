...
public class TemplateMaker {
    ...
    public static void main(String[] args) {
        ...
        String inputFilePath2 = "src/main/java/com/maison/project/constant";
...
//        String searchStr = "Sum: ";
        ...
        long id = makeTemplate(meta, originProjectPath, templateMakerFileConfig, modelInfo, searchStr, 1939245558331129856L);
